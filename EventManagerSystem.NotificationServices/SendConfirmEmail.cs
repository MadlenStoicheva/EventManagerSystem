...
namespace EventManagerSystem.NotificationServices
{
    public class SendConfirmEmail
    {
        ...
        //private string confirmationEmailUrl = "http://newlibraryproject.apphb.com/User/ValidateEmail";
        ...
        public void SendConfirmationEmailAsync(User user)
        {
            ...
            SendConfirmationEmail(user.Email, "EventManagerSystem registration request", $"To confirm your account click  -> {link}");
        }
